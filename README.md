...
ACQ400 firmware releases from 2019 on
 ...
 # INSTRUCTIONS
  ...
  # Intialization files in /mnt/local
...
We try to avoid patch files on shipment, but sometimes it's necessary. in particular
   1. /mnt/local/acq420fmc.ko is a patch driver and must/will be blown away by the release
   2. /mnt/local/ACQxxx_TOP_aa_bb*.bit.gz is a patch FPGA image. if one is fitted to your system, please contact D-TACQ for update advice.
